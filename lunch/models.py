...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    sex = models.CharField(max_length=10, verbose_name='جنسیت', choices=[('man', 'مرد'), ('woman', 'زن')], null=True, blank=True)
    ...
    rfid = models.CharField(max_length=10, verbose_name='کد RFID', null=True, blank=True)
